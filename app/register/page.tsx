...
const Register = ({name="",email="", password="", confirmPassword=""}: RegisterInterface) => {
    ...
    const validate = (values:any) => {
        ...
        if (!values.confirmPassword) {
            ...
            errors.confirmPassword = "Not matches with Password Field";
        }
        return errors;
    };
                            ...
                            <div className="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                                <div className="flex flex-col md:flex-row">
                                    <div className="h-32 md:h-auto md:w-1/2">
                                        <Image className="object-cover w-full h-full" height={100} width={100} src="" alt="Register" />
                                    </div>
                                        ...
                                        <div className="w-full">
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                {signupError && signupError && (
                                                  <span style={{color:"red"}} className="error">{signupError}</span>
                                                )}
                                            </form>
