          ...
          <div className="w-full bg-zinc-800 text-slate-300 px-10 py-10">
            <div className="flex justify-between border-b pb-8">
              ...
              <h2 className="font-semibold text-2xl">
                {cart.items.length > 0 ? cart.items.length : 0} Items
              </h2>
            </div>
            {cart.items.length === 0 ? (
              ...
              <>
                ...
                {cart.items.map((item: ItemInterface) => (
                  <div
                    ...
                    className="flex items-center text-black bg-zinc-300 hover:bg-gray-100 hover:text-black p-5"
                  >
                    ...
                    <div className="flex justify-center w-1/5">
                      <input
                        className="mx-2 border text-center text-slate-700 w-8"
                        type="text"
                        value={item.quantity}
                        onChange={() => {}}
                      />
                    ...
                    <div className="flex justify-center w-1/5">
                      <button
                        className="fill-current text-white bg-black rounded w-4"
                        onClick={() =>
                ...
                <div className="flex justify-between items-center mt-6 pt-6 border-t">
                  ...
                  <div className="flex justify-center items-end">
                    ...
                    <span className="text-lg ml-3 font-bold text-gray-300">
                      £{totalBillAmout()}
                    </span>
                  </div>
                  <div className="flex">
                    <Link href="/checkout">
                      <button className="bg-white hover:bg-slate-500 hover:text-slate-100 text-black font-bold py-3 px-5 rounded">
                        Checkout
                      </button>
                    </Link>
                  </div>
